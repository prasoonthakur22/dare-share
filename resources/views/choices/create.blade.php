        ...
        <div class="bg-transparent  px-4 py-12 sm:mx-6 lg:mx-8">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="text-center">
                    <h4 class="text-3xl text-slate-900 font-semibold mt-1 mb-12 pb-1">Create Choice for Question: <span class="font-bold">{{ $quizze->question }}</span> </h4>
                </div>
                <div class="text-center">
                ...
                <!-- Choices Start -->
                <form id="choicesForm" method="POST" action="{{ route('store.choice') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="rounded-xl px-10 py-10 group shadow-lg hover:shadow-md hover:shadow-slate-800 drop-shadow-xl shadow-slate-800">
                        <div class="my-8">
                            ...
                            <input placeholder="Enter answer" name="answer" id="answer" type="text" class="form-control input-md  block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-red-600 focus:outline-none" value="{{ old('answer') }}" required autocomplete="answer" autofocus>
                            @error('question')
                        ...
                        <div class="my-8">
                            <label class="label">
                                <p class="label-text text-slate-900 text-xl mb-2">Answer Image</p>
