        ...
        <div class="bg-transparent  px-4 py-12 sm:mx-6 lg:mx-8">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="text-center">
                    <h4 class="text-3xl text-slate-900 font-semibold mt-1 mb-12 pb-1">Update Dare</h4>
                </div>

                <form method="POST" action="{{ route('update.dare', ['dare_id' => $dare->id] ) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="rounded-xl px-10 py-10 group shadow-lg hover:shadow-md hover:shadow-slate-800 drop-shadow-xl shadow-slate-800">
                        ...
                        <div class="my-8">
                            ...
                            <input placeholder="{{ $dare->title }}" id="dare_title" type="text" class="form-control input-md  block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-red-600 focus:outline-none" name="dare_title" value="{{ $dare->title }}" required autocomplete="dare_title" autofocus>
                            @error('dare_title')
                        ...
                        <div class="my-8">
                            ...
                            <input placeholder="{{ $dare->description }}" id="dare_description" type="text" class="form-control input-md block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-red-600 focus:outline-none" name="dare_description" value="{{ $dare->description }}" autocomplete="dare_description">
                        ...
                        <div class="my-8">
                            <p class="label-text text-slate-900 text-xl mb-2">Old Dare Image</p>
                            <div class="bg-transparent object-cover flow-root max-w-sm card rounded-lg drop-shadow-3xl overflow-hidden items-center ">
                                <div class="float-left object-cover">
                                    <figure><img class="object-cover" src="{{ asset('storage/' . $dare->image) }}" /></figure>
                                </div>
                            </div>

                            <label class="label">
                                <p class="label-text text-slate-900 text-xl mb-2">New Dare Image</p>
                                <p class="label-text-alt">Optional</p>
                            </label>
                            <!-- FileInfo  -->
